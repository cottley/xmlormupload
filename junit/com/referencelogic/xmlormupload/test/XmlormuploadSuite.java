...
public class XmlormuploadSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.referencelogic.xmlormupload.test.Test";

    public static void main(String args[]) {
        new TestSuite(XmlormuploadSuite.class).run(new TestResult());
    }
